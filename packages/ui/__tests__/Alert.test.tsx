...
import { Alert, AlertType, AlertAction, AlertActions } from '../src/Alert'
...
describe('Alert', () => {
  const alertBasicTestData: [AlertType, Icon][] = [
    ['success', CheckCircle],
    ['info', Info],
  ...
  const alertActionsTestData: [string, string, AlertActions, any[]][] = [

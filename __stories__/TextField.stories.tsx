...
import { TextField, TextFieldProps, TextFieldTypes } from '../src/components/TextField'
...
const Template: StoryFn<TextFieldProps<TextFieldTypes>> = ({ value: initialValue, ...args }) => {
